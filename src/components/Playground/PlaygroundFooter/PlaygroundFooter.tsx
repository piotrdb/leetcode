    ...
    <div className="flex bg-dark-layer-1 absolute bottom-0 z-10 w-full">
      <div className="ml-5 mr-8 my-[12px] flex justify-between w-full">
        <div className="mr-2 flex flex-1 flex-nowrap items-center space-x-4">
          <button className="px-3 py-1.5 font-medium items-center transition-all inline-flex bg-dark-fill-3 text-md hover:bg-dark-fill-2 text-dark-label-2 rounded-lg pl-3 pr-2">
            Console
